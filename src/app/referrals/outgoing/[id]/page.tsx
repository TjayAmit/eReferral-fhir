...
export default function ReferralDetailPage() {
  ...
  async function load() {
    ...
    setError(null);
    try {
      // Persist the requested-referral fetch: read the ServiceRequest by its id.
      // The shared detail view resolves everything else (patient, facilities,
      // vitals, clinical data, task, provenance) from this ServiceRequest.
